--This test runs the cube mission through target offsets
--rather than distance and velocity control 
        ...
        if (vehicle:get_mode() == POS_HOLD and stage == 0) then          -- change to guided mode
          ...
          elseif (stage >= 3 and stage <= 11) then  
            ...
            if (start_loc and curr_loc) then
              ...
              if (stage == 3) then
                vehicle:set_target_location(tri_target1)
              ...
              if (stage == 6) then
                ...
                vehicle:set_target_location(tri_target2)
                if (dist_NED:y() >= 8.66 and dist_NED:x() <= 5 ) then
              ...
              if (stage == 9) then
                ...
                vehicle:set_target_location(tri_target3)
