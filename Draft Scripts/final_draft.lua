...
local rc_channel_F = 8  --Secondary switch for arm release if limit switch fails: flipped upon confirmation of payload parachute inflation
local rc_channel_C = 7 --Setting should be checked, releases the arms upon visual confirmation of parachute deployment
